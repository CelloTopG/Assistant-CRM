 ...
 *
 * Comprehensive complaints analysis with filters, charts, and Antoine AI integration.
...
function show_antoine_dialog(report) {
    let d = new frappe.ui.Dialog({
        title: __("Ask Antoine - Complaints Analytics Assistant"),
        fields: [
            {
                fieldname: "query",
            ...
            },
            {
                fieldname: "response",
                fieldtype: "HTML",
                options: '<div class="antoine-response" style="min-height:120px;padding:12px;background:#f5f7fa;border-radius:4px;"><em>Ask a question to get AI-powered complaints insights...</em></div>'
            }
        ],
